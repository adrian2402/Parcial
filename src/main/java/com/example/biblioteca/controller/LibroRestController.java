...
public class LibroRestController {
    ...
    public int editPost(@RequestBody Libro li) {  
        Libro pos = new Libro(li.getIdlibro(),li.getTitulo(),li.getIdioma(),li.getPag(),li.getDescripcion(),li.getIdautor(),li.getIdeditorial());
        System.out.println(li.getIdlibro()+" , "+li.getTitulo()+" , "+li.getIdioma()+" , "+li.getPag()+" , "+li.getDescripcion()+" , "+li.getIdautor()+" , "+li.getIdeditorial());
