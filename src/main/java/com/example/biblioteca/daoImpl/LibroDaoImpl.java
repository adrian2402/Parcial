...
public class LibroDaoImpl implements LibroDao {
    ...
    public int create(Libro li) {
        ...
        return jdbcTemplate.update(SQL, new Object[]{li.getTitulo(), li.getIdioma(), li.getPag(), li.getDescripcion(), li.getIdautor(), li.getIdeditorial()});
    }
    ...
    public int update(Libro li) {
        ...
        return jdbcTemplate.update(SQL, new Object[]{li.getTitulo(), li.getIdioma(), li.getPag(), li.getDescripcion(), li.getIdautor(), li.getIdeditorial(), li.getIdlibro()});
    }
